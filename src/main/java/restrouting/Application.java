...
public class Application
{
  ...
  {
    ApiInfo apiInfo = new ApiInfo("ExCELL Routing API", "This API provides an optimized routing for the ExCELL test area (Dresden).", "Version 1.0", "Use only for testing", "fkunde@beuth-hochschule", "Apache 2", "http://www.apache.org/licenses/LICENSE-2.0");
    return apiInfo;
  }
