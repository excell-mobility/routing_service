...
//    private double separatedSearchDistance = 1000;
////    private int maxVisitedNodes = (int) Math.pow(10,10);//500
//    private int maxVisitedNodes = (int) Math.pow(10,10); //2147483647;//500
...
////            System.out.println("GPXEntry prevEntry: "+ prevEntry);
//            double gpxLength = 0;
...
////                System.out.println("gpxLength distanceCalc:"+gpxLength);
//                prevEntry = entry;
...
//                    if (ext.getQueryResult().getQueryDistance() < minimumDist) {
//                        minimumDist = ext.getQueryResult().getQueryDistance();
//                    }
//                }
//
...
////        System.out.println("List<EdgeMatch> length before: " + inputList.size());
////        inputList = removeMatchDuplicates(inputList);
////        System.out.println("List<EdgeMatch> length after: " + inputList.size());
...
//    }
//
//    private List<EdgeMatch> removeMatchDuplicates(List<EdgeMatch> list){
//        int count = list.size();
