...
public class RoutingService
{
  ...
  private ExCeGraphHopper hopper;

  private String osmFile;
  private String ghLocation;

  @Autowired
  public RoutingService(@Value("${routing.osmfile}") String osmFile, @Value("${routing.ghlocation}") String ghLocation)
  { 
    log = LoggerFactory.getLogger(this.getClass());
    this.osmFile = osmFile;
    this.ghLocation = ghLocation;
    hopper = (ExCeGraphHopper) new ExCeGraphHopper().forServer();
  ...
  public RoutingResponse startRouting(double startLat, double startLon, double endLat, double endLon)
  {
    ...
    GHRequest req = new GHRequest(startLat, startLon, endLat, endLon).setWeighting("fastest").setVehicle("car").setLocale(Locale.GERMAN);
    ...
    return new RoutingResponse(rsp.getDistance(), rsp.getTime(), getPointListDoubles(rsp.getPoints()));
  }
  ...
  public ExCeGraphHopper getHopper()
  {
    return hopper;
  }
}
